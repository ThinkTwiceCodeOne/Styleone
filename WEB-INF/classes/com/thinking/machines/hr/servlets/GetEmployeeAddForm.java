...
pw.println("<td><input type='text' id='name' name='name' maxlength='50' size='51'><br>");
...
pw.println("<td><input type='date' id='dateOfBirt' name='dateOfBirth'><br>");
...
pw.println("<td><input type='checkbox' name='isIndian' id='isIndian'>");
pw.println("</td>");
pw.println("</tr>");
pw.println("<tr>");
...
pw.println("<td>");
pw.println("<input type='text' id='panNumber' name='panNumber' maxlength='15' size='15'>");
pw.println("<br>");
...
pw.println("<td>");
pw.println("<input type='text' id='aadharCardNumber' name='aadharCardNumber' maxlength='15' size='15'>");
pw.println("<br>");
